...
class EASER:
    def __init__(self, reg_lambda: float, smoothing: float = 0.01):
        self.B = None
        self.reg_lambda = reg_lambda # Regularization 값
        self.smoothing = smoothing # Smoothing 값 (기본값: 0.01)
